...
@Mod(OritechAddon.MOD_ID)
public class OritechAddon
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "extendedoritech";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public OritechAddon(IEventBus modEventBus, ModContainer modContainer)
    {
